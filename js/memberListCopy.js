        ...
        $.ajax({
             ...
             else if(detailId ==9)
            {
              ...
              else if(detailId == 13)
              {
                  ...
                  if( (roleName == 'Club President'))
                  {
                //  alert(clubID);
                      display +='<figure2><figcaption id="caption1">'+roleName+'</figcaption><img src="'+ url +'" id="img1" ><figcaption id="caption2">'+name+'</figcaption><p><figcaption id="caption3">International  ID-'+'<span id="IntID">'+id+'</span>'+'</figcaption></p><p><figcaption id="caption4">H C-'+'<span id="clubdata">'+clubName+'</span>'+'</figcaption></p><p><figcaption id="caption4">REGION-'+'<span id="clubdata">'+regionName+'</span>'+'</figcaption></p><p><figcaption id="caption4">ZONE-'+'<span id="clubdata">'+zoneName+'</span>'+'</figcaption></p></figure2> ';
                    
                      $('#title').append(display);
                     count1++;
                      p++;
                  }
              if((roleName == 'Club Secretary'))
                  {
                  
                      display +='<figure2><figcaption id="caption1">'+roleNameroleName+'</figcaption><img src="'+ url +'" id="img1" ><figcaption id="caption2">'+name+'</figcaption><p><figcaption id="caption3">International  ID-'+'<span id="IntID">'+id+'</span>'+'</figcaption></p><p><figcaption id="caption4">H C-'+'<span id="clubdata">'+clubName+'</span>'+'</figcaption></p><p><figcaption id="caption4">REGION-'+'<span id="clubdata">'+regionName+'</span>'+'</figcaption></p><p><figcaption id="caption4">ZONE-'+'<span id="clubdata">'+zoneName+'</span>'+'</figcaption></p></figure2> ';
