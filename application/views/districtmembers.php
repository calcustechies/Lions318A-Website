        ...
        <section id="main">
            <div id="page" style="padding-top: 50px;">
                ...
                <div class="row" style="margin: 20px;">
                    ...
                    <label style="font-size: 15px;">REGION:</label>
                    <select class="form-control" id="regiondata" onchange="viewRegionBasedmember()">
                ...
                <select class="form-control" id="zonedata" disabled onchange="viewzonebasedmember()">
                ...
                <div class="col-md-4 col-sm-4">
                <label style="font-size: 15px;">CLUB:</label>
                <select class="form-control   memberdetails" id="clubdata" disabled>
                ...
                <div class="row" style="margin: 20px;">
                    ...
                    <table id="memberTable" class="display responsive" style=" width: 100%;">
