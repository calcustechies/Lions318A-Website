...
<!-- 	 Calender-->
      <link rel="stylesheet" href="<?php echo base_url();?>assets/calender/style.css">
    <link rel="stylesheet" href="<?php echo base_url();?>assets/calender/evo-calendar.midnight-blue.min.css">
    <link rel="stylesheet" href="<?php echo base_url();?>assets/calender/evo-calendar.min.css">
...
<body id="one-page-home" class="page page-id-8 page-template page-template-template-onepage page-template-template-onepage-php custom-background _masterslider _msp_version_2.9.12 waves-pagebuilder menu-fixed header-transparent theme-full">
    ...
    <div id="theme-layout">
        ...
        <div class="header-container">
            <header id="header" class="header-large clearfix" style="background-color: #112E57;">
                ...
                <div class="tw-logo">
                    <a class="logo" href="<?php echo base_url('Index');?>"><img class="<?php echo base_url();?>logo-img" src="<?php echo base_url();?>images/lions/logos/lionsA.png" alt="Lions Club - District 318D" /></a>
                </div>
                    ...
                    <div class="tw-menu-container">
                        <ul id="menu" class="sf-menu">
                            ...
                            <li class="menu-item"><a href="<?php echo base_url('Districtmembers');?>">District Members</a></li>
                              <li class="menu-item tw-menu-active"><a href="<?php echo base_url('DistrictCalender');?>" style="font-size=12px;">District Calender</a></li>
        ...
        <section id="main">
            ...
            <div id="page" style="padding-top: 50px;">
                <div class="col-md-12">
                    <h4 class="text-center" style="background-color:#FFCF01;padding:10px;margin-top:10px;color:#112E57"> District Calender
                    </h4>
                <div class="hero" style="margin-top: 350px;">

        <div id="calendar" style="margin-bottom: 350px;"></div>
    ...
    var base_url = $('#base').val();
        // Initialize evo-calendar in your script file or an inline <script> tag
            ...
            type: 'POST',
            url: base_url + "EventCtrl/EventCalender",
            data: {
        ...
        width: 100%;">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8">
                        <p class="copyright">
                            © 2021<a href='#' title='Lions Club Internation - District 318D'>LCI - District 318D |
...
<script src="<?php echo base_url();?>assets/calender/evo-calendar.min.js"></script>
