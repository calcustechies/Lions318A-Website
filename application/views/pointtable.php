...
<head>
    ...
    <title>Lions Club International - District 318A</title>
    ...
    <div id="theme-layout">
                ...
                <nav class="menu-container clearfix">
                    <div class="tw-menu-container">
                        <ul id="menu" class="sf-menu">
                            ...
                            <li class="menu-item tw-menu-active"><a href="<?php echo base_url('Pointtable');?>">Points Table</a></li>
                            ...
                            <li class="menu-item"><a href="<?php echo base_url('Districtmembers');?>">District Members</a></li>
                             <li class="menu-item"><a href="<?php echo base_url('DistrictCalender');?>">District Calender</a></li>
        ...
        <section id="main">
            ...
            <div id="page" style="padding-top: 50px;">
                <div class="col-md-12">
                    <h4 class="text-center" style="background-color:#FFCF01;padding:10px;margin-top:10px;color:#112E57"> CLUB POINTS
                    </h4>
                </div>
                <div class="row" style="margin: 20px;">
                    <div class="col-md-6 col-sm-6" >
                    <label style="font-size: 15px;">Category:</label>
                    <select class="form-control clubpointdetails" id="categoryID">
                ...
                <select class="form-control clubpointdetails" id="monthID">
                                <option value="">ALL</option>
                 ...
                 <div class="row" style="margin: 20px;">
                     <div class="container text-center">
                         <h3>To View Points.Please Login <i class="fa fa-hand-o-right blink"></i> <button class="menu-item btn btn-primary" style="background-color:#112E57;min-width: 110px;"><a href="http://controlpanel.lions318a.com/" style="color:white" target="_blank">Login</a> </h3>
                     </div>
                     </div>
                    ...
                    <table id="datatabledata" class="display" style=" width: 100%;">
                        ...
                        <tbody>
                            ...
                            <!-- <tr>
                                ...
                                <td>1</td>
                                <td>
                                    <a href="<?php //echo base_url('Clubname');?>">Lions Club Trichur Ayyanthole</a>
...
<input type="hidden" id="base" value="<?php echo base_url(); ?>">
        ...
        <script src="<?php echo base_url(); ?>js/general/clubpoints.js"></script>
