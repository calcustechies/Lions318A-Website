...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo base_url();?>images/lions/logos/favicon.ico" type="image/x-icon" />
...
@media  (min-device-width: 320px) and (max-device-width: 441px) {
       figure,figure2 {
    ...
    <div id="theme-layout">
        ...
        <div class="header-container">
            <header id="header" class="header-large clearfix" style="background-color: #112E57;">
                ...
                <div class="tw-logo">
                    <a class="logo" href="<?php echo base_url('Index');?>"><img class="<?php echo base_url();?>logo-img" src="<?php echo base_url();?>images/lions/logos/lionsA.png" alt="Lions Club - District 318A" /></a>
                </div>
                <nav class="menu-container clearfix">
                    <div class="tw-menu-container">
                        <ul id="menu" class="sf-menu">
                            ...
                            <li class="menu-item "><a href="<?php echo base_url('DistrictCalender');?>" style="font-size=12px;">District Calender</a></li>
                            <li class="menu-item tw-menu-active "><a href="<?php echo base_url('Districtmembers');?>">District Members</a></li>
                             <li class="menu-item" ><a href="<?php echo base_url('assets/img/contestRule.pdf');?>" style="font-size=12px;" target="_blank">Contest Rule</a> </li>
                             <li class="menu-item"><a href="https://lci-auth-app-prod.azurewebsites.net/account/login">MY LCI</a></li>
                            <li class="menu-item btn btn-primary"><a href="http://controlpanel.lions318a.com">Login</a></li>
                            
                            
                    <div class="tw-logo" style="margin-top: 5px;">
                    <a class="logo" href="<?php echo base_url('Index');?>">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  &nbsp;&nbsp;<img class="<?php echo base_url();?>logo-img" src="<?php echo base_url();?>images/lions/logos/lcilogo.png" alt="Lions Club - District 318A" /></a>
                </div>
                        </ul>
                    </div>
                </nav>
        ...
        <section id="main">
            <div id="page" style="padding-top: 50px;">
                <div class="col-md-12">
                    <h4 class="text-center" style="background-color:#FFCF01;padding:10px;margin-top:10px;color:#112E57"> DISTRICT MEMBERS
                    </h4>
                </div>
                 <div class="col-md-4">
                     </div>
                     <div class="col-md-4">
                       <select class="form-control" id="roleList" onchange="viewdatas()">
                        <option value="1">DG TEAM</option>
                        <option value="2">Chief Patron & Mentors</option>
                        <option value="3">District Advisors</option>
                        <option value="4">Cabinet Secretary</option>
                        <option value="5">Additional  CABINET SECRETARY</option>
                        <option value="6">JOINT  CABINET SECRETARY</option>
                        <option value="7">Regional  and zone  Chairperson</option>
                        
                        <option value="8">District Coordinator</option>
                        <option value="9">District Lady Circle PST & Area Coordinator</option>
                        <option value="10">District Leo PST</option>
                        <option value="12">District Chairpersons</option>
                        <option value="13">Club PST</option>
                        
                      </select>
                     </div>
                     <!--<div class="col-md-4">-->
                     <!--</div>-->
                    <div class="row tw-element waves-portfolio waves-isotope-container col-md-12">
                                       <div class=" col-md-12" style="" id="title">
                                        
                                        <!--<div class="row" tw-element waves-portfolio waves-isotope-container>-->
        ...
        width: 100%;">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8">
                        <p class="copyright">
                            © 2021<a href='#' title='Lions Club Internation - District 318A'>LCI - District 318A |
