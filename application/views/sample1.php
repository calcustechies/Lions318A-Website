    ...
    <div id="theme-layout">
        ...
        <div class="header-container">
            <header id="header" class="header-large clearfix" style="background-color: #112E57;">
                ...
                <div class="tw-logo">
                    <a class="logo" href="<?php echo base_url('Index');?>"><img class="<?php echo base_url();?>logo-img" src="<?php echo base_url();?>images/lions/logos/NewLogo.png" alt="Lions Club - District 318D" /></a>
                </div>
                <nav class="menu-container clearfix">
                    <div class="tw-menu-container">
                        <ul id="menu" class="sf-menu">
                           ...
                           <li class="menu-item tw-menu-active "><a href="#">What We Do</a>
                            <ul class="dropdown-content">
                  <li ><a href="<?php echo base_url('OurProjects');?>">Our Projects</a></li>
                  <li  style="text-decoration-line: underline ;" ><a href="<?php  echo base_url('CActivities');?>">We Serve</a></li>
        ...
        <section id="main">
            <div id="page" style="padding-top: 50px;">
                <div class="col-md-12">
                    <a href="<?php echo base_url('CActivities');?>" target="_blank"><button  class="btn btn-primary"   id="b2"  >Back to Post </button></a>
                </div>
                                       ...
                                       <b> <h3 id="contestRule" style="color: green"></h3> </b> 
                                        <hr/>
                                         ...
                                         <ul class="list-inline">
                                             <li><i class="fa fa-building" style="color:#FFCF01"></i>&nbsp;&nbsp;Region - </li>
                                             <li>|</li>
                                                <li><i class="fa fa-server" style="color:#112E57"></i>&nbsp;&nbsp;Zone - </li>
                                         <li>|</li>
