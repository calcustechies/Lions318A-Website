...
<head>
    ...
    <link rel='stylesheet' href='<?php echo base_url();?>css/master-custom.css' type='text/css' media='all' />
     ...
     <link rel="stylesheet" href="https://cdn.datatables.net/responsive/2.2.5/css/dataTables.responsive.css">
    ...
    <div id="theme-layout">
            ...
            <header id="header" class="header-large clearfix" style="background-color: #112E57;">
                ...
                <nav class="menu-container clearfix">
                    <div class="tw-menu-container">
                        <ul id="menu" class="sf-menu">
                            ...
                            <li class="menu-item tw-menu-active dropdown" style="padding-bottom:32px;"><a href="#" >What We Do</a> 
                            
                 <ul class="dropdown-content">
                  <li class="active"  ><a href="<?php echo base_url('OurProjects');?>">Our Projects</a></li>
                  <li><a href="<?php  echo base_url('CActivities');?>"  style="text-decoration-line: underline ;"  target="_blank">Contest Rule</a></li>
                ...
                <nav id="mobile-menu">
                    <ul id="menu-one-page-new" class="clearfix">
                        ...
                        <li class="menu-item"><a href="<?php echo base_url('Gallery');?>">Gallery</a></li>
                        <li class="menu-item tw-menu-active"><a href="<?php echo base_url('Districtmembers');?>">District Members</a></li>
                        <li class="menu-item  dropdown drop"><a href="#">What We Do</a> 
                           <ul class="dropdown-content ">
                            <li><a href="<?php echo base_url('OurProjects');?>">Our Projects</a></li>
                            <li><a href="<?php  echo base_url('CActivities');?>" target="_blank">Contest Rule</a></li>
        ...
        <section id="main">
            <div id="page" style="padding-top: 50px;">
                <div class="col-md-12">
                    <a href="<?php echo base_url('CActivities');?>"><button  class="btn btn-primary"   id="b2"  >Back to Post </button></a>
                </div>
...
<div class="row">
          ...
          <!--<div class="tw-element waves-portfolio waves-isotope-container col-md-12" style="" id="title">-->
         
        <section class="blog-post-area">
            <div class="container">
                <div class="row">
                    <div class="blog-post-area-style " id="activityBlog">
                             <div class="col-md-12">
                                <div class="single-post-big">
                                    <div class="col-lg-12">
                                        <div class="big-text">
                                       <b> <h3 id="contestRule" style="color: green"></h3> </b> 
                                        <hr/>
                                          <div class="post-by" style="padding:5px;">
                                         <ul class="list-inline">
                                             <li><i class="fa fa-building" style="color:#FFCF01"></i>&nbsp;&nbsp;Region - &nbsp;&nbsp;<b><span id="region" style="color:#2e6da4;"></span></b>  </li>
                                             <li>|</li>
                                                <li><i class="fa fa-server" style="color:#112E57"></i>&nbsp;&nbsp;Zone - &nbsp;&nbsp;<b><span id="zone" style="color:#2e6da4;"></span></b> </li>
                                         <li>|</li>
                                            <li><i class="fa fa-building-o" style="color:green"></i>&nbsp;&nbsp;H C - &nbsp;&nbsp;<b><span id="club" style="color:#2e6da4;"></span></b> </li>
                                           </ul>
                                         </div>
                                        
                                        <hr/>
                                        <p id="activityDescription" style="padding:15px;"></p>
                                       
                                        <hr/>
                                       
                                       
                                            <div class="col-lg-3">
                                                <h4><i class="fa fa-users" style="color:orange;"></i>&nbsp; Lions Involved -&nbsp;<span id="lions" style="color:#2e6da4;"></span>
                                                </div>
                                                
                                             <div class="col-lg-3">
                                                <h4><span style="text-align: justify;"><i class="fa fa-clock-o" style="color: green;"></i> &nbsp;Lion Hours Utilized - &nbsp;<span id="time" style="color:#2e6da4;"></span></span></h5> 
                                                </div>
                                                
                                                <div class="col-lg-3">
                                                <h4><span style="text-align: justify;"><i class="fa fa-user" style="color: orange;"></i> &nbsp;People Served - &nbsp;<span id="persons" style="color:#2e6da4;"></span></span></h5> 
                                                </div>
                                                
                                                 <div class="col-lg-3">
                                                <h4><span style="text-align: justify;"><i class="fa fa-money" style="color: green;"></i> &nbsp;Amount Spend - &nbsp;<span id="money" style="color:#2e6da4;"></span></span></h5> 
                                                </div>
                                            
                                            <!--<div class="col-lg-6">-->
                                            <!--    <h4><i class="fa fa-money" style="color:green;"></i>&nbsp; &nbsp;Amount Spent - &nbsp;&nbsp;<span id=""></span>-->
                                            <!--    </div>-->
                                           ...
                                           <div class="col-lg-6">
                                                <h4><i class="fa fa-calendar" style="color:green;"></i>&nbsp;&nbsp;<span id="date"></span>
                                                </div>
                                                
                                             <div class="col-lg-6">
                                                <h4><span style="text-align: justify;"><i class="fa fa-user" style="color: orange;"></i> <span id="postedBY" ></span></span></h5> 
                                                </div>
                                                
                                                <hr/>
                                    </div>
                                    </div>
                                    <div class="col-lg-6 col-md-12 preview1">
                                         <a class="example-image-link" href="" id="link1" data-lightbox="example-set" data-title="">
                                        <img  class="img1 image1" alt=""   width="100%" height="100%">
                                        </a>
                                     </div>
                                     <div class="col-lg-6 col-md-12 preview2">
                                    <a class="example-image-link" href="" id="link2" data-lightbox="example-set" data-title="">
                                    <img  class="img1 image2"  alt=""  width="100%" height="100%" >
                                    </a>
                                  </div>
                            ...
                            <!--<h4 class="card-body"><span><i class="fa fa-user" style="color:orange"></i> <span class="author-name">Kabbo Liate</span></span></h4>-->
                            <!--         <hr/>-->
...
<input type="hidden" id="activityID" value="<?php echo $i; ?>">

     <script src="<?php echo base_url();?>js/CActivity_single.js"></script>
    ...
    <script src="<?php echo base_url();?>js/jquery.min.js"></script>
        ...
        <script src="<?php echo base_url(); ?>js/general/member.js"></script>
