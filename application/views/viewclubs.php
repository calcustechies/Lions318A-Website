    ...
    <div id="theme-layout">
        ...
        <div class="header-container">
            <header id="header" class="header-large clearfix" style="background-color: #112E57;">
                ...
                <div class="tw-logo">
                    <a class="logo" href="index.html"><img class="<?php echo base_url();?>logo-img" src="<?php echo base_url();?>images/lions/logos/lionsA.png" alt="Lions Club - District 318D" /></a>
                </div>
        ...
        <section id="main">
            <div id="page" style="padding-top: 50px;">
                <div class="col-md-12">
                    <h4 class="text-center" style="background-color:#FFCF01;padding:10px;margin-top:10px;color:#112E57"> VIEW CLUBS
                    </h4>
                </div>
                <div class="row" style="margin: 20px;">

                    <table id="viewallclubdetails" class="display" style=" width: 100%;">

                        <thead>
                            <tr>
                                <th>CLUB INTERNATIONAL ID</th>
                                <th>CLUB NAME</th>
                                <th>PRESIDENT</th>
                                <th>SECRETARY</th>
                                <th>TREASUREE</th>
...
<input type="hidden" id="base" value="<?php echo base_url(); ?>">
        ...
        <script src="<?php echo base_url(); ?>js/general/viewclubs.js"></script>
        <script>
