...
<head>
    ...
    <title>Lions Clubs International - District 318D</title>
       ...
       <!-- Start Main -->
        <div  id="main">
            <div id="page" style="padding-top: 50px;">
                <div class="col-md-12">
                    <h4 class="text-center" style="background-color:#FFCF01;padding:10px;margin-top:10px;color:#112E57"> WHAT WE DO
                    </h4>
                </div>
                 <div class="col-md-4">
                     </div>
                     <div class="col-md-4">
                       <select class="form-control" id="contestRuleList" onchange="activityData()">
...
-->
                ...
                <div class="nav-links" id="pegination">
...
<input type="hidden" id="base" value="<?php echo base_url(); ?>">
     ...
     <script src="<?php echo base_url();?>js/CActivities.js"></script>
