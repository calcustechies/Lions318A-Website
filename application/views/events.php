    ...
    <div id="theme-layout">
        ...
        <div class="header-container">
            <header id="header" class="header-large clearfix" style="background-color: #112E57;">
                ...
                <div class="tw-logo">
                    <a class="logo" href="<?php echo base_url('Index');?>"><img class="logo-img" src="<?php echo base_url();?>images/lions/logos/lionsA.png" alt="Lions Club - District 318A" /></a>
                </div>
                <nav class="menu-container clearfix">
                    <div class="tw-menu-container">
                        <ul id="menu" class="sf-menu">
                            ...
                            <li class="menu-item tw-menu-active"><a href="<?php echo base_url('Events');?>">Events</a></li>
        ...
        <section id="main">
            <div id="page" style="padding-top: 50px;">
                <div class="col-md-12">
                    <h4 class="text-center" style="background-color:#FFCF01;padding:10px;margin-top:10px;color:#112E57">EVENTS
                    </h4>
                </div>
                ...
                <div class="row" style="margin: 20px;">
                    ...
                    <input class=" form-control eventdetails" value="2021-07-01"  type="date" id="start_date" min="2021-07-01">
                ...
                <div class="col-md-4 col-sm-4">
                <label style="font-size: 15px;">Event Type:</label>
                <select class="form-control eventdetails" id="eventtype">
                                <option value="0">Choose Event</option>
                                <option value="1">District Event</option>
                                <option value="2">Regional Event</option>
                                <option value="3">Club Event</option>
                ...
                <input class="form-control eventdetails" value="2022-06-30"  type="date" id="endDate" max="2022-06-30">
                ...
                <div class="row" style="margin: 20px;">
                    ...
                    <table id="eventdatatable" class="display" style=" width: 100%;">
